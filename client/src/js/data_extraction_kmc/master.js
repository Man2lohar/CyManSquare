...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (treecoversum) {
        document.getElementById('pro-tree').textContent = `${treecoversum.toFixed(3)} Sq.m.`;
    } else {
        document.getElementById('pro-tree').textContent = 0 + ' Sq.m.';
    }
    // Displaying Cupboard / Loft area:
    if (cbloftsum) {
        document.getElementById('pro-cb').textContent = `${cbloftsum.toFixed(3)} Sq.m.`;
    } else {
...
function showPopup() {
    ...
    updateButton.addEventListener('click', function() {
        ...
        if (!isNaN(park)) {
            document.getElementById('per-park-area').textContent = formatNumber(park.toFixed(3));
...
function calculateFAR() {
    ...
    const floorAreaRatioTable = [
        ...
        { width: [15.0, 20.0], residential: 2.5, educational: 2.5, industrial: 2.0, storage: 2.0, hazardous: 2.0, assembly: 2.25 , business: 2.25, institutional: 2.25, mercantile_retail:2.25, Mercantile_wholesale:2.25},
        { width: [20.0, 24.0], residential: 2.75, educational: 2.75, industrial: 2.0, storage: 2.0, hazardous: 2.0, assembly: 2.5 , business: 2.5, institutional: 2.5, mercantile_retail:2.5, Mercantile_wholesale:2.5},
...
function TreeCover(){
    ...
    if (treecoverCell) {
        treecoverCell.textContent = (treecover.toFixed(3)) + " Sq.m.";
    }
    const cbloftAreaCell = document.getElementById('per-cb');
    if (cbloftAreaCell) {
        cbloftAreaCell.textContent = (cbloftArea.toFixed(3)) + " Sq.m.";
    }
}
...
const minimumOpenSpaces = {
    residential: [
        ...
        { height: "Above 15.5 M. up to 20.0 M.", front: "3.5 M.", side1: "4.0 M.", side2: "4.0 M.", rear: "5.0 M." },
        { height: "Above 20.0 M. up to 25.5 M.", front: "5.0 M.", side1: "5.0 M.", side2: "5.0 M.", rear: "6.5 M." },
    ...
    educational: [
        ...
        { height: "Above 15.5 M. up to 20.0 M.", front: "5.0 M.", side1: "5.0 M.", side2: "5.0 M.", rear: "6.0 M." },
        { height: "Above 20.0 M.", front: "20% of the height of building or 6 M., whichever is more", side1: "20% of the height of building or 5 M., whichever is more", side2: "20% of the height of building or 5 M., whichever is more", rear: "20% of the height of building or 8 M., whichever is more" }
    ],
    institutional: [
        ...
        { height: "Above 10.0 M. up to 20.0 M.", front: "4.0 M.", side1: "4.0 M.", side2: "4.0 M.", rear: "5.0 M." },
        { height: "Above 20.0 M. up to 25.5 M.", front: "5.0 M.", side1: "5.0 M.", side2: "5.0 M.", rear: "6.0 M." },
    ...
    industrial: [
        ...
        { height: "Above 10.0 M. up to 20.0 M.", front: "12.5 M.", side1: "6.0 M.", side2: "6.5 M.", rear: "10.0 M." },
        { height: "Above 20.0 M.", front: "20% of the height of building or 6 M., whichever is more", side1: "20% of the height of building or 6.5 M., whichever is more", side2: "20% of the height of building or 6.5 M., whichever is more", rear: "20% of the height of building or 10.0 M., whichever is more" }
    ],
    Storage: [
        { height: "Up to 10.0 M.", front: "12.5 M.", side1: "5.0 M.", side2: "4.0 M.", rear: "4.0 M." },
        { height: "Above 10.0 M. up to 20.0 M.", front: "12.5 M.", side1: "6.0 M.", side2: "6.5 M.", rear: "10.0 M." },
